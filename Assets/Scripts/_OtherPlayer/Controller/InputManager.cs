...
public class InputManager : NetworkBehaviour
{
    ...
    private void OnEnable()
    {
        if(playerControls == null) 
        {
            ...
            playerControls.PlayerActions.Walking.performed += i => walk_Input = true;
            playerControls.PlayerActions.Walking.canceled += i => walk_Input = false;
    ...
    {
        if (walk_Input && (!playerLocomotion.isSprinting && moveAmount > 0.1f))
        {
